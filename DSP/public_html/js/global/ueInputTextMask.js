...
Ext.define('Ext.global.ueInputTextMask', {
   alias: 'widget.ueInputTextMask',
   ...
   processMaskFormatting: function(e, type) {
     // console.log(this.inputTextElement.readOnly);
      if (this.inputTextElement.readOnly){
         return;
      }
      this.oldCursorPos=null;
   ...
   getCursorPosition: function() {
      ...
      if (this.viewMask == this.inputTextElement.value){
         s = 0;
         e = 0;   
      }
