...
insert  into `contratos`(`cod_contrato`,`pro_descri`,`fecha_ing`,`fecha_act`,`id_user`,`estado`) values (1,'Area1','2018-12-06',NULL,1,'A'),(2,'Area2','2018-12-06',NULL,1,'A'),(3,'Aera2','2018-12-06','2018-12-06',1,'A'),(4,'Area3','2018-12-06',NULL,2,'A');
...
insert  into `fac_cliente`(`fac_cliente`,`shi_codigo`,`cod_contrato`,`fac_estado`) values (1,1,1,'A'),(2,2,2,'A'),(3,1,3,'A'),(4,1,4,'A');
...
IF vp_op = 'I' then 
	if ifnull(vp_nombre,'') != '' then
		select count(*) into vl_exits from contratos where upper(trim(pro_descri)) = upper(trim(vp_nombre));
		if ifnull(vl_exits,0) = 0 then
...
IF vp_op = 'U' then 
     if ifnull(vp_nombre,'') != '' then
        ...
        if ifnull(vl_exits,0)= 0 then 
			set vl_exits = 0;
			SELECT COUNT(*) INTO vl_exits FROM contratos WHERE UPPER(TRIM(pro_descri)) = UPPER(TRIM(vp_nombre)) and cod_contrato != vp_cod_contrato;
			if ifnull(vl_exits,0)= 0 then 
